                        ...
                        <div class="table-responsive">
                            <table id="example" class="display table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            @if ($array_hasil_soal['iter'][$i] <= 60)
                                                {{ $kc1++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 61 && $array_hasil_soal['iter'][$i] <= 120)
                                                {{ $kc2++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 121 && $array_hasil_soal['iter'][$i] <= 180)
                                                {{ $kc3++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 181 && $array_hasil_soal['iter'][$i] <= 240)
                                                {{ $kc4++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 241 && $array_hasil_soal['iter'][$i] <= 300)
                                                {{ $kc5++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 301 && $array_hasil_soal['iter'][$i] <= 360)
                                                {{ $kc6++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 361 && $array_hasil_soal['iter'][$i] <= 420)
                                                {{ $kc7++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 421 && $array_hasil_soal['iter'][$i] <= 480)
                                                {{ $kc8++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 481 && $array_hasil_soal['iter'][$i] <= 520)
                                                {{ $kc9++ }}
                                            @endif
                                            @if ($array_hasil_soal['iter'][$i] >= 521 && $array_hasil_soal['iter'][$i] <= 600)
                                                {{ $kc10++ }}
                                            @endif
                                        </td>
                                        <td>

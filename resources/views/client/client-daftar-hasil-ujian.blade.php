                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <span style="color:black;">
                                    Nama Peserta : {{ $item->data->data_nama }} <br />
                                    Nama Ujian : {{ $item->ukom->ukom_nama }} <br />
                                    Kategori Ujian : {{ strtoupper($item->ukom->ukom_kategori) }} <br />
                                    Jawaban Benar : {{ strtoupper($item->hasil_benar) }} <br />
                                    Jawaban Salah : {{ strtoupper($item->hasil_salah) }} <br />
                                    Total Nilai : {{ strtoupper($item->hasil_total_nilai) }} <br />
                                </span>
                            </div>
                        </div>
